    ...
    const presupuestoReglaSuggest = _presupuestoNum > 0
      ? `\n- PRESUPUESTO MÁXIMO: $${_presupuestoNum} USD por persona TOTAL — el precio_estimado de CADA opción DEBE ser ≤ $${_presupuestoNum}. ${
          _presupuestoDiaSuggest < 100
            ...
            ? `Con $${_presupuestoDiaSuggest}/día prioriza LATAM y Europa mid-range. Hawaii, Maldivas, Dubái, Islandia y Seychelles requieren mínimo $200/día para una experiencia completa — solo sugiérelos si el presupuesto claramente lo permite.`
